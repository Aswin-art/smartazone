...
@section('content')
    ...
    <div class="bg-white min-h-screen font-sans text-neutral-900 pb-32" data-mountain-id="1">
        ...
        @guest
            ...
            <div class="px-6 py-12 text-center opacity-0 animate-enter" style="animation-delay: 0.1s">
                ...
                <h2 class="text-xl font-semibold text-neutral-900 mb-3">Akses Diperlukan</h2>
                <p class="text-sm text-neutral-500 mb-8 max-w-xs mx-auto">Silakan masuk untuk melanjutkan proses pemesanan Anda
                    dengan aman.</p>
                <div class="flex flex-col gap-3">
                    <a href="/auth"
                        class="w-full py-3.5 bg-[#1B4965] text-white text-xs font-bold uppercase tracking-wider rounded-full hover:bg-[#153a51] transition-colors">
                        Masuk
                    </a>
                    <a href="/auth"
                        class="w-full py-3.5 border border-neutral-200 text-neutral-600 text-xs font-bold uppercase tracking-wider rounded-full hover:bg-neutral-50 transition-colors">
                        Daftar
                    </a>
                </div>
            </div>
        ...
        @if ($errors->any())
            <div class="fixed top-24 left-1/2 -translate-x-1/2 z-50 w-full max-w-md px-6 animate-enter">
                <div
                    class="bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-xl shadow-lg flex items-start gap-3">
                    <svg class="w-5 h-5 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="square" stroke-linejoin="miter" stroke-width="1.5"
                            d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <div>
                        <h3 class="font-bold text-sm">Mohon periksa masukan Anda</h3>
        ...
        @auth
            <div class="px-6 -mt-8 relative z-20">
                <!-- Progress Steps -->
                <div class="bg-white rounded-2xl shadow-lg shadow-neutral-100 border border-neutral-100 p-4 mb-8 flex items-center justify-between max-w-sm mx-auto opacity-0 animate-enter"
                    style="animation-delay: 0.1s">
                    <div class="flex items-center gap-2">
                        <div class="w-2 h-2 rounded-full bg-[#1B4965]"></div>
                        <span class="text-[10px] font-bold uppercase tracking-widest text-[#1B4965]">Jadwal</span>
                    </div>
                    ...
                    <div class="flex items-center gap-2">
                        <div class="w-2 h-2 rounded-full bg-neutral-200"></div>
                        <span class="text-[10px] font-bold uppercase tracking-widest text-neutral-400">Bayar</span>
                    </div>
                </div>
                ...
                <div class="space-y-8 opacity-0 animate-enter" style="animation-delay: 0.2s">
                    ...
                    <section class="bg-white rounded-3xl border border-neutral-200 p-6 space-y-6">
                        <div class="flex items-center gap-3 mb-2">
                            <span
                                class="w-6 h-6 rounded-full bg-[#1B4965]/10 text-[#1B4965] text-xs font-bold flex items-center justify-center">1</span>
                            <h2 class="text-sm font-bold uppercase tracking-wide text-neutral-900">Pilih Jadwal</h2>
                        </div>

                        <div class="grid grid-cols-1 gap-5">
                            <div class="space-y-1.5">
                                <label
                                    class="text-[10px] font-bold text-neutral-400 uppercase tracking-widest ml-1">Keberangkatan</label>
                                <input type="date" id="departureDate"
                                    class="w-full px-4 py-3.5 bg-neutral-50 border-0 rounded-xl text-neutral-900 font-medium focus:ring-2 focus:ring-[#1B4965]/20 focus:bg-white transition-all outline-none">
                            </div>
                            <div class="space-y-1.5">
                                <label
                                    class="text-[10px] font-bold text-neutral-400 uppercase tracking-widest ml-1">Kembali</label>
                                <input type="date" id="returnDate"
                                    class="w-full px-4 py-3.5 bg-neutral-50 border-0 rounded-xl text-neutral-900 font-medium focus:ring-2 focus:ring-[#1B4965]/20 focus:bg-white transition-all outline-none">
                            </div>
                            <div class="space-y-1.5">
                                <label
                                    class="text-[10px] font-bold text-neutral-400 uppercase tracking-widest ml-1">Pendaki</label>
                                <div class="relative">
                                    <input type="number" id="climberCount" min="1" max="10" value="1"
                                        class="w-full px-4 py-3.5 bg-neutral-50 border-0 rounded-xl text-neutral-900 font-medium focus:ring-2 focus:ring-[#1B4965]/20 focus:bg-white transition-all outline-none">
                                    <span
                                        class="absolute right-4 top-1/2 -translate-y-1/2 text-xs font-medium text-neutral-400">Orang</span>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <div id="formContainer" class="space-y-8 hidden">
                        <section class="bg-white rounded-3xl border border-neutral-200 p-6 space-y-6">
                            <div class="flex items-center gap-3 mb-2">
                                <span
                                    class="w-6 h-6 rounded-full bg-[#1B4965]/10 text-[#1B4965] text-xs font-bold flex items-center justify-center">2</span>
                                <h2 class="text-sm font-bold uppercase tracking-wide text-neutral-900">Data Ketua</h2>
                            </div>

                            <div class="space-y-4">
                                <div class="space-y-1.5">
                                    <label class="text-[10px] font-bold text-neutral-400 uppercase tracking-widest ml-1">Nama
                                        Lengkap</label>
                                    <input type="text" id="leaderName" placeholder="Sesuai KTP"
                                ...
                                <div class="space-y-1.5">
                                    <label
                                        class="text-[10px] font-bold text-neutral-400 uppercase tracking-widest ml-1">Email</label>
                                    <input type="email" id="leaderEmail" placeholder="example@email.com"
                                        value="{{ auth()->user()->email ?? '' }}"
                                        class="w-full px-4 py-3.5 bg-neutral-50 border-0 rounded-xl text-neutral-900 font-medium focus:ring-2 focus:ring-[#1B4965]/20 focus:bg-white transition-all outline-none placeholder:text-neutral-300">
                                </div>
                                <div class="space-y-1.5">
                                    <label
                                        class="text-[10px] font-bold text-neutral-400 uppercase tracking-widest ml-1">Telepon</label>
                                    <input type="tel" id="leaderPhone" placeholder="08xxxxxxxxxx"
                        ...
                        <div id="memberDataBtn" class="hidden">
                            <button onclick="openMemberModal()"
                                class="w-full group bg-white border border-neutral-200 rounded-2xl p-5 flex items-center justify-between hover:border-[#1B4965] transition-all duration-300 shadow-sm hover:shadow-md">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="text-left">
                                        <p id="memberBtnText"
                                            class="font-bold text-neutral-900 text-xs uppercase tracking-wide">Data Anggota</p>
                                        <p class="text-[10px] text-neutral-400 mt-0.5">Diperlukan untuk asuransi</p>
                                    </div>
                                </div>
                                <svg class="w-4 h-4 text-neutral-300 group-hover:text-[#1B4965] transition-colors"
                        ...
                        <button id="equipmentBtn" disabled
                            class="w-full group bg-white border border-neutral-200 rounded-2xl p-5 flex items-center justify-between hover:border-[#1B4965] transition-all duration-300 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:border-neutral-200 disabled:hover:shadow-none">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-10 h-10 rounded-full bg-[#1B4965]/5 flex items-center justify-center text-[#1B4965] group-hover:bg-[#1B4965] group-hover:text-white transition-colors">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="text-left">
                                    <p class="font-bold text-neutral-900 text-xs uppercase tracking-wide">Sewa Peralatan</p>
                                    <p class="text-[10px] text-neutral-400 mt-0.5">Opsional · Tenda, Jaket, dll.</p>
                                </div>
                            </div>
                            <svg class="w-4 h-4 text-neutral-300 group-hover:text-[#1B4965] transition-colors" fill="none"
                        ...
                        <div class="bg-neutral-50 rounded-3xl p-6 border border-neutral-100">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <h3 class="text-xs font-bold uppercase tracking-widest text-neutral-900">Ringkasan Biaya</h3>
                            </div>

                            <div class="space-y-3">
                                <div class="flex justify-between items-center text-sm">
                                    <span class="text-neutral-500">Tiket Masuk</span>
                                    <span id="entranceFee" class="font-semibold text-neutral-900">Rp 0</span>
                                </div>
                                <div class="flex justify-between items-center text-sm">
                                    <span class="text-neutral-500">Biaya Pendaki (<span id="climberDisplay">1</span>x)</span>
                                    <span id="climberFee" class="font-semibold text-neutral-900">Rp 0</span>
                                </div>
                                <div class="flex justify-between items-center text-sm">
                                    <span class="text-neutral-500">Peralatan</span>
                    ...
                    <div class="pt-4">
                        <button id="submitBtn" disabled
                            class="w-full bg-[#1B4965] text-white font-bold py-4 px-6 rounded-full transition-all hover:bg-[#153a51] hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-none flex items-center justify-center gap-3 group">
                            <span class="text-xs uppercase tracking-widest">Lanjut ke Pembayaran</span>
    ...
    <div id="equipmentModal"
        ...
        <div class="bg-white rounded-3xl shadow-2xl max-w-md w-full max-h-[85vh] overflow-hidden flex flex-col">
            <div class="p-6 border-b border-neutral-100 flex items-center justify-between bg-white">
                <div>
                    <h2 class="text-sm font-bold text-neutral-900 uppercase tracking-wide">Peralatan</h2>
                    <p class="text-[10px] text-neutral-500 mt-1">Tambahan opsional</p>
                </div>
            ...
            <div class="border-t border-neutral-100 p-6 bg-neutral-50">
                ...
                <button id="confirmEquipment"
                    class="w-full bg-[#1B4965] text-white font-bold py-3.5 rounded-full transition-all hover:bg-[#153a51] uppercase tracking-widest text-xs">
                    Simpan Pilihan
                </button>
            </div>
        </div>
    ...
    <div id="memberModal"
        ...
        <div class="bg-white rounded-3xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-hidden flex flex-col">
            <div class="p-6 border-b border-neutral-100 flex items-center justify-between bg-white">
                <div>
                    <h2 class="text-sm font-bold text-neutral-900 uppercase tracking-wide">Data Anggota</h2>
                    <p class="text-[10px] text-neutral-500 mt-1">Lengkapi semua detail pendaki</p>
                </div>
            ...
            <div class="border-t border-neutral-100 p-6 bg-white">
                <div class="flex justify-between items-center mb-4">
                    <span class="text-xs font-bold uppercase tracking-widest text-neutral-500">
                        Terisi: <span id="completedMembers" class="text-[#1B4965]">0</span>/<span
                            id="totalMembers">0</span>
                    </span>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function checkDatesAndShowForm() {
                if (departureDate.value && returnDate.value) {
                    ...
                    if (returnD <= departure) {
                        alert('Tanggal kembali harus setelah tanggal keberangkatan');
                        returnDate.value = '';
                        return;
                    }
            ...
            function updateMemberDataButton(count) {
                ...
                if (count > 1) {
                    ...
                    memberBtnText.textContent = `Data Anggota (${remainingMembers} orang)`;
                } else {
            ...
            function createMemberForm(member, index) {
                ...
                div.innerHTML = `
                    <h4 class="font-bold mb-4 text-[10px] uppercase tracking-widest text-[#1B4965]">Anggota ${index + 1}</h4>
                    <div class="space-y-3">
                        <input type="text" placeholder="Nama Lengkap" value="${member.name}" onchange="updateMemberData(${index}, 'name', this.value)" class="w-full px-4 py-3 bg-neutral-50 border-0 rounded-xl text-sm focus:ring-2 focus:ring-[#1B4965]/20 focus:bg-white transition-all outline-none">
                        ...
                        <input type="tel" placeholder="Telepon" value="${member.phone}" onchange="updateMemberData(${index}, 'phone', this.value)" class="w-full px-4 py-3 bg-neutral-50 border-0 rounded-xl text-sm focus:ring-2 focus:ring-[#1B4965]/20 focus:bg-white transition-all outline-none">
                    </div>
                `;
                return div;
            }
            ...
            function updateMemberProgress() {
                const completedMembers = memberData.filter(member => member.name.trim() !== '' && member.email
                    .trim() !== '' && member.phone.trim() !== '' && member.nik.trim() !== '').length;
                ...
                if (completedMembers === memberData.length && memberData.length > 0) {
                    ...
                    memberBtnText.textContent = `Data Anggota (${memberData.length} orang)`;
            ...
            function showEquipmentModal() {
                ...
                equipmentData.forEach(item => {
                    ...
                    itemDiv.className =
                        'border border-neutral-200 rounded-2xl p-4 bg-white hover:border-[#1B4965]/50 transition-all';
                    itemDiv.innerHTML = `
                        <div class="flex justify-between items-start mb-3">
                            <div>
                                <p class="font-bold text-sm text-neutral-900">${item.name}</p>
                                <p class="text-[10px] text-neutral-500 mt-0.5">Rp ${item.price.toLocaleString('id-ID')}/hari</p>
                            </div>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-[10px] font-bold text-neutral-400 uppercase tracking-widest">Jumlah</span>
            ...
            confirmEquipment.addEventListener('click', function() {
                ...
                btnText.textContent = itemCount > 0 ? `Peralatan Terpilih (${itemCount} item)` :
                    'Sewa Peralatan';
            ...
            submitBtn.addEventListener('click', function() {
                if (!submitBtn.disabled) {
                    ...
                    if (!leaderName || !leaderEmail || !leaderPhone) {
                        alert('Mohon lengkapi semua detail ketua');
                        return;
                    }

                    if (memberData.length > 0) {
                        const incompletemembers = memberData.filter(m => !m.name.trim() || !m.email
                            .trim() || !m.phone.trim() || !m.nik.trim());
                        if (incompletemembers.length > 0) {
                            alert('Mohon lengkapi semua detail anggota');
                            return;
                        }
                    }
